...
export function registerSettings() {
    const settings = {
        ...
        passiveClickToChat: {
            name: game.i18n.localize("enhancedcombathud-daggerheart.settings.passiveClickToChat.name"),
            hint: game.i18n.localize("enhancedcombathud-daggerheart.settings.passiveClickToChat.hint"),
            scope: "world",
            config: true,
            type: Boolean,
            default: true,
